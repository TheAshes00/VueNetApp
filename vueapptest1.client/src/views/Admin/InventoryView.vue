...
export default {
    ...
    async created(){
        ...
        await this.adminStore.subGetAllPaginatedMaterial(objPages);
        this.subPaginate()
    },
    components: {
        // ModalComponent,
    ...
    methods:{
        ...
        subPaginate(){
            if(
                this.adminStore.objPaginateMaterial != null
            ){
                //                                          //Get info from getter
                let objPagMat = this.adminStore.objGetObjPaginateMaterial;

                this.intPageNumber =  objPagMat.intPageNumber;
                this.intPageSize = objPagMat.intPageSize;
                this.arrMaterial = objPagMat.objPaginatedObject; 
                this.intTotalCount = objPagMat.intTotalCount;
        ...
        editMaterial(
            ...
            this.strModalTitle = "Edit Material";
            let objMaterial = this.arrMaterial.find(
                obj => obj.strNumCtrlInt === strNumCtrlInt_I);
            this.objSelectedElement = objMaterial
        ...
        async subSaveEdit(
            ...
            if(
                ...
                await this.adminStore.subSetAddMaterial(this.objSelectedElement)

                this.subRealoadMaterial()
        ...
        subAddNew(){
            this.boolEditInModal = false;
            this.strModalTitle = "New Material";
            this.boolShowModal = true;
        },
        ...
        boolCheckModal(){
            ...
            if(
                ...
                this.objSelectedElement.strNumCtrlInt &&
                this.objSelectedElement.strMarerialType &&
                this.objSelectedElement.strCodeType
            )
            {
                boolIsValid = true
            }
        ...
        <div class="table-responsive-sm">
            ...
            <table class="table align-middle table-color" v-else>
                ...
                <tbody class="tbody-color">
                    <tr v-for="material in arrMaterial" :key="material.intPk">
                        <td>{{ material.strNumCtrlInt }}</td>
                        <td>{{ material.strName }}</td>
                        <td>{{ material.strMarerialType }}</td>
                        <td>{{ material.strCodeType }}</td>
